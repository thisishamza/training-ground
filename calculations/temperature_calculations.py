def get_maximum_humidity_yearly(maximum_humidity_every_month):
    yearly_values = {}
...
def get_maximum_temperature_yearly(maximum_temperature_every_month):
    yearly_values = {}
...
def get_minimum_temperature_yearly(minimum_temperature_every_month):
    yearly_values = {}
...
def highest_lowest_temperature(yearly_weather_readings, year):
...
def average_highest_lowest_temperature(monthly_weather_readings, date):
